...
if player_first_string == "S" then
    yield("/echo Starting "..player_first_string.." configuration.")
...
--Fate Combat Settings
    ...
    UseBM = true                        --if you want to use the BossMod dodge/follow mode
        BMorBMR = "BMR"
        MeleeDist = 2.5                     --distance for BMRAI melee. Melee attacks (auto attacks) max distance is 2.59y, 2.60 is "target out of range"
        RangedDist = 15                     --distance for BMRAI ranged. Ranged attacks and spells max distance to be usable is 25.49y, 25.5 is "target out of range"=
